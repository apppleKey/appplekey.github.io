...
![img](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2c3819fb0c404ae5a8f4cddc4e80731e~tplv-k3u1fbpfcp-zoom-1.image) `forEach`跟map类似，唯一不同的是`forEach`是没有返回值的。
